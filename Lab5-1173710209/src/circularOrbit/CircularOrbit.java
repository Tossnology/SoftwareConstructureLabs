...
/**
 * 一个环形轨道系统，其中包括中心点物体、轨道物体、轨道 L为中心点物体类型，E为轨道物体类型，都必须为immutable.
 * 
 * @author yRXX
 *
 * @param <L>
...
public interface CircularOrbit<L, E extends PhisicalObject> {
   ...
   * @param track
   *          新的轨道
   * @return 如果系统中已经存在相同的轨道，则不变并返回false 如果不存在，则添加并返回true
   */
   ...
   * @param track
   *          要删除的轨道
   * @return 如果系统中已经存在相同的轨道，则删除并返回true 如果不存在，则不变并返回false
   */
