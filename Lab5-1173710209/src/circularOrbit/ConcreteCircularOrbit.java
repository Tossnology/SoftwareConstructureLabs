...
public class ConcreteCircularOrbit<L, E extends PhisicalObject> implements CircularOrbit<L, E> {
   ...
   * AF(CentralObjects,TrackObjects,tracks,relations)=一个环形轨道系统 
   * Representation invariant: CentralObjects:中心物体列表 TrackObjects:轨道物体列表 tracks:轨道集合
   * relations:关系图 
  ...
  public boolean addCentralObject(L object) {
    return CentralObjects.add(object);
  }
