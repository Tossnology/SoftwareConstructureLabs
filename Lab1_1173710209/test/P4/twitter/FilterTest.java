...
public class FilterTest {
    ...
    private static final Tweet tweet3 = new Tweet(3, "alyssa", "gg", d3);
    private static final Tweet tweet4 = new Tweet(4, "alyssa", "glhf", d4);
    private static final Tweet tweet5 = new Tweet(5, "yrxx", "hello", d5);
    private static final Tweet tweet6 = new Tweet(6, "noob", "I'm a noob", d6);
    ...
    public void testWrittenByMultipleTweetsSingleResult() {
        ...
        assertEquals("expected list", 2, writtenBy.size());
        ...
        List<Tweet> writtenBy1 = Filter.writtenBy(Arrays.asList(tweet1, tweet2,tweet3), "yrxx");
        assertTrue("expected empty set", writtenBy1.isEmpty());
    }
    ...
    public void testInTimespanMultipleTweetsMultipleResults() {
        ...
        List<Tweet> inTimespan = Filter.inTimespan(Arrays.asList(tweet4, tweet2,tweet6,tweet3,tweet5), new Timespan(testStart, testEnd));
        
        assertFalse("expected non-empty list", inTimespan.isEmpty());
        assertTrue("expected list to contain tweets", inTimespan.containsAll(Arrays.asList(tweet3, tweet2,tweet4)));
    ...
    public void testContaining() {
        List<Tweet> containing = Filter.containing(Arrays.asList(tweet1, tweet2,tweet5,tweet4), Arrays.asList("talk","hello"));
