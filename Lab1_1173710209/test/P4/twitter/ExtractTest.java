...
public class ExtractTest {
	...
	private static final Tweet tweet2 = new Tweet(2, "bbitdiddle", "rivest talk in 30 minutes #hype @yRXX @", d2);
	private static final Tweet tweet3 = new Tweet(3, "yRXX", "Hi @alyssa 462272701@qq.com @Peter @PeTer @Dr.Evil", d3);
	...
	public void testGetMentionedUsersNoMention() {
		...
		truth.add("peter");
		truth.add("yrxx");
		assertEquals(truth, mentionedUsers1);
	}
