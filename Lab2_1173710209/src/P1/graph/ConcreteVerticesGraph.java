...
/**
 * 图中的节点元素，包括一些信息 (节点名字，它指向的的邻接点和权重)
 * Mutable. This class is internal to the rep of
...
class Vertex<L> {
	...
	/**
	 * 断绝邻接关系(删除一条边)
	 * @param name 邻接点的名字，非空，对应节点必须包含在vertices中
	 */
	...
	/**
	 * 新增邻接关系(新增一条边)
	 * @param name 邻接点名字，非空，对应节点必须包含在vertices中
	 * @param weight 权重，正整数
	 */
	public void putTarget(L name,int weight) {
